  ...
  <section class="fav">
    <div class="container">
      <div class="fav__top">
        ...
        <h1 class="fav__title">Мои закладки</h1>
      </div>
        ...
        <div class="fav_empty">
          ...
          <router-link to="/">
            <button class="fav_empty_btn">
              ...
              <text class="fav_empty_btntext">Вернуться назад</text>
            </button>
          </router-link>
        </div>
        <Card v-for="good in goods" :key="good.id" :good="good" />
      </div>
    </div>
  </section>
</template>
...
export default {
  ...
  setup() {
    ...
    const goods = store.state.favorites;
    return {
      goods,
    };
  },
