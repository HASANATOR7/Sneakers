      ...
      <div class="drawer">
        ...
        <template v-if="$store.getters.getCartLength">
          <div class="drawer__content">
            <div v-for="cartItem in $store.state.cart" :key="cartItem.id" class="cartItem">
          ...
          <div class="drawer__bottom">
            ...
            <button @click="$store.commit('addOrders', goods)" class="order__btn">
              Оформить заказ
              <svg
                width="16"
                height="14"
        ...
        <div v-else>
          <img @click="$store.commit('changeDrawer', false)" src="../assets/empty.png" alt="">
        </div>
      </div>
    </div>
    <div class="container">
